...
public class BoardCotrollerImpl implements BoardController { /*image를 imagefile 로 바꿔봐*/
	...
	private String upload(MultipartHttpServletRequest multipartRequest)throws Exception{
		...
		System.out.println("board imgname : " + imageFileName);
	...
	public ResponseEntity removeArticle(@RequestParam("articleNO") int articleNO, HttpServletRequest request, HttpServletResponse response)
		...
		ResponseEntity resEnt = null;
		HttpHeaders responseHeaders = new HttpHeaders();
		responseHeaders.add("Content-Type", "text/html; utf-8");
		try {
